...
class UPRNLookupTestCase(LoadTestData, TestCase):
    ...
    def test_uprn_json_output(self):
        self.assertJSONEqual(
            self.client.get("/uprn/77281020.json").content,
            {
                ...
                "postcode": "TE15TT",
                "uprn": 77281020,
                "wgs84_lat": 50.72748566697889,
                "wgs84_lon": -3.455734399454025,
                "addressbase_core": {
                    "building_name": "",
                    "building_number": "13",
                    "change_code": "I",
    ...
    def test_uprn_html_output(self):
        ...
        self.assertInHTML(
            """<li>WGS84 lat/lon: <a href="https://tools.wmflabs.org/geohack/geohack.php?params=50.727486;-3.455734">50.727486, -3.455734</a></li>""",
            html,
        )
